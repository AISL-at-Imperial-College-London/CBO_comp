function T_opt = solveOptimization_UCB_series(T0, P_dis_ref, GP_Power, GP_Pdis, GP_ds1, GP_ds2, params)
% SOLVEOPTIMIZATION_UCB_SERIES Global search using GA for 2-compressor series UCB.
